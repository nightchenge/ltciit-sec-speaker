 ...
 * @Last Modified time: 2023-09-06 16:59:02
 */
...
#define KEY_FILTER_TIME                 (20)    /** 消抖滤波时间，单位ms */
#define KEY_DBL_INTERVAL                (300)   /** 双击最大间隔时间，单位ms */
...
static volatile int MyKeyLock = 0;             
